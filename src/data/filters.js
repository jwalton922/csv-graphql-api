...
function isGreaterThan(value, compareValue) {
...
function isGreaterThanOrEqual(value, compareValue) {
  return isEqual(value, compareValue) || isGreaterThan(value, compareValue);
}

function isLessThan(value, compareValue) {
  if (value === null || value === undefined) return false;
...
function isLessThanOrEqual(value, compareValue) {
...
function containsString(value, searchString) {
  if (value === null || value === undefined) return false;
...
function startsWithString(value, searchString) {
  if (value === null || value === undefined) return false;
...
function endsWithString(value, searchString) {
  if (value === null || value === undefined) return false;
 ...
 */
function applyNestedFilters(data, filters, relationships, database, tableName) {
  if (!filters || Object.keys(filters).length === 0) {
    return data;
  }
 ...
 */
function hasMatchingRelatedRecord(parentRecord, relationship, relationshipFilter, database) {
 ...
 */
function getRelationshipFieldName(relationship) {
