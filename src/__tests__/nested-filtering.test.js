const { applyNestedFilters } = require('../data/filters');
const { DatabaseManager } = require('../data/database');
const { Relationship } = require('../schema/types');
...
describe('Nested Filtering', () => {
  ...
  describe('applyNestedFilters', () => {
    ...
    it('should apply relationship filters correctly', () => {
      ...
      mockDatabase.query.mockImplementation((sql, params = []) => {
